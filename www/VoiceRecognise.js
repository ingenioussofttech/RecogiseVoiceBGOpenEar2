...
(function() {
  ...
  VoiceRecognise = (function() {
    ...
    trigger = function(evt, args) {
      return document.dispatchEvent(new CustomEvent(evt, {
        detail: args
                    ...
                    VoiceRecognise.prototype.PlayBackgroundFile = function() {
                    var success;
                    ...
                    return exec(success, genericHandleError, "VoiceRecognise", "PlayBackgroundFile", []);
                    };
                    
                    
                    VoiceRecognise.prototype.StopBackgroundFile = function() {
                    var success;
                    ...
                    return exec(success, genericHandleError, "VoiceRecognise", "StopBackgroundFile", []);
                    };
    ...
    VoiceRecognise.prototype.setMatchWord = function(languageName, languageCSV) {
     ...
     VoiceRecognise.prototype.startRecord = function() {
                    var success;
                    
                    success = function(args) {
                    
                    return trigger("startRecord", args);
                    };
                    return exec(success, genericHandleError, "VoiceRecognise", "startRecord", []);
                    };
                    
                    VoiceRecognise.prototype.stopRecord = function() {
                    var success;
                    
                    success = function(args) {
                    
                    return trigger("stopRecord", args);
                    };
                    return exec(success, genericHandleError, "VoiceRecognise", "stopRecord", []);
                    };
                    
                    
                    VoiceRecognise.prototype.playRecord = function() {
                    var success;
                    
                    success = function(args) {
                    
                    return trigger("playRecord", args);
                    };
                    return exec(success, genericHandleError, "VoiceRecognise", "playRecord", []);
                    };
    VoiceRecognise.prototype.generateLanguageModel = function(languageName, languageCSV,secondaryarr) {
                    var success;
                    
                    success = function(args) {
                    return trigger("generateLanguageModel", args);
                    };
                    return exec(success, genericHandleError, "VoiceRecognise", "generateLanguageModel", [languageName, languageCSV.toUpperCase(),secondaryarr.toUpperCase()]);
   };
    ...
    VoiceRecognise.prototype.events = {
      ...
      receivedHypothesis: function(hypothesis) {
